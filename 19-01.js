...
let addTwoPara = (num1,num2=5) =>{// we pass default default value to protect our code from errors
console.log(num1);
console.log(num2);
return num1 + num2;
...
let  maxOfNumbers=(...numbers) =>{
 ...
 obj1.name='helen'// this change will not visible in original array
